...
const PointTracker = () => {
  ...
  const updatePoints = async (user, newPoints) => {
    try {
      ...
      await axios.patch("https://aqueous-caverns-75509-5acc57c13eba.herokuapp.com/brackets/updatePoints", {
        bracket_id,
        user,
        points: newPoints,
      });
      ...
      const response = await axios.get("https://aqueous-caverns-75509-5acc57c13eba.herokuapp.com/brackets/One", {
        params: { bracket_id },
      });
